                        ...
                        <div className="col-lg-3 col-md-3 col-sm-12">
                            ...
                            <div className="footer-list-div">
                                <ul>
                                    ...
                                    <li>Welcome to BookMyFood.</li>
                                    <li> We're dedicated to giving you the very best snacks,</li>
            
                                    <a href="/Menu"><li><button style={{"backgroundColor":"#e0a63a"}}>ReadMore</button></li></a>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div className="footer-list-div">
                                ...
                                <ul>
                                    <li className="pb-3">
                                        ...
                                        <span>+91 8748834611</span>
                                    </li>
                                    <li className="pb-3">
                                        <span className="bg-warning p-2 rounded mr-3">
                                            <FontAwesomeIcon icon="envelope" className="text-white" />
                                        </span>
                                        <span>BookMyFood123@gmail.com</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
